    ...
    <body class="animsition">
                    ...
                    <nav class="limiter-menu-desktop p-l-45">
                        ...
                        <div class="menu-desktop">
                            <ul class="main-menu">
                                ...
                                <!-- data-label1="hot" -->
                                <li class="label1" >
                                    <a href="shopingcart">Shopping cart</a>
                                </li>
                        ...
                        <div class="wrap-icon-header flex-w flex-r-m h-full">							
                            <div class="flex-c-m h-full p-r-25 bor6">
                                ...
                                <div class=" cl0 hov-cl1 trans-04 p-lr-11 login" >
                                    <a href="logout">${requestScope.data}</a>
                                </div>


                                <div class=" cl0 hov-cl1 trans-04 p-lr-11 login" >
                                    <a href="login.jsp" style=" display: ${requestScope.display}">Login</a>
                                </div>
                            </div>

                            <div class="flex-c-m h-full p-lr-25 bor6">
            ...
            <div class="sidebar flex-col-l p-t-22 p-b-25">
                ...
                <div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
                    <ul class="sidebar-link w-full">
                        ...
                        <li class="p-b-13">
                            <a href="shopingcart" class="stext-102 cl2 hov-cl1 trans-04">
                                Order
                            </a>
                        </li>
        ...
        <section class="section-slide">
            <div class="wrap-slick1 rs2-slick1">
                <div class="slick1">
                    <div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-05.jpg);" data-thumb="images/thumb-01.jpg" data-caption="Womens Wear">
                    ...
                    <div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-06.jpg);" data-thumb="images/thumb-02.jpg" data-caption="Mens Wear">
                        <div class="container h-full">
                            <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
                    ...
                    <div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-07.jpg);" data-thumb="images/thumb-03.jpg" data-caption="Mens Wear">
                        <div class="container h-full">
                            <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
        ...
        <section class="bg0 p-t-23 p-b-130">
            <div class="container">
                ...
                <div class="row isotope-grid">
                    <c:forEach items="${requestScope.bestseller}" var="c" >
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${c.categoryName}">
                            <!-- Block2 -->


                            <div class="block2">
                                <div class="block2-pic hov-img0 label-new" data-label="Hot">
                                    <img src="${c.image}" alt="IMG-PRODUCT">

                                    <a href="productdetail?id=${c.productId}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
                                        View Details
                                    </a>
                                </div>
            ...
            <div class="container">
                ...
                <div class="flex-c-m flex-w w-full p-t-38">
                    <c:forEach begin="${1}" end="${requestScope.number}" var="i">
                        <a href="index?page=${i}" class="flex-c-m how-pagination1 trans-04 m-all-7 ${i==page?"active-pagination1":""} ">${i}</a>
                    </c:forEach>
