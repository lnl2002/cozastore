        ...
        <div class="wrap-header-cart js-panel-cart">
            ...
            <div class="header-cart flex-col-l p-l-65 p-r-25">
                ...
                <div class="header-cart-content flex-w js-pscroll">
                    <ul id="mini-cart" class=" header-cart-wrapitem w-full">
        ...
        <section class="sec-product-detail bg0 p-t-65 p-b-60">
                ...
                <div class="row">
                        ...
                        <div class="p-l-25 p-r-30 p-lr-0-lg">
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb">
                                    <div class="item-slick3" data-thumb="${requestScope.image}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="${requestScope.image}" alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${requestScope.image}">
                    ...
                    <div class="col-md-6 col-lg-5 p-b-30">
                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                            ...
                            <!--  -->
                            <div class="p-t-33">
                                <div class="flex-w flex-r-m p-b-10" style="display: ${requestScope.display}">
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <select class="js-select2 size" name="size">
                                                <c:forEach items="${requestScope.listSize}" var="c">
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    <div class="size-204 flex-w flex-m respon6-next">
                                        <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                            ...
                                            <input class="amount mtext-104 cl3 txt-center num-product" type="number" name="num-product" value="1">
                                        ...
                                        <button  onclick="addToCart(${requestScope.productId})" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
                                            Add to cart
                                        </button>
                                    </div>
                                </div>	
            ...
            <div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
                <span class="stext-107 cl6 p-lr-25">
                    Product ID: ${requestScope.productId}
                </span>

                <span class="stext-107 cl6 p-lr-25">
                    Categories: ${requestScope.categoryName}
                </span>
            </div>
        </section>
    ...
    function addToCart(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var row = document.getElementById("mini-cart");
                row.innerHTML += data;
            },
            error: function (xhr) {
