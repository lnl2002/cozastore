 ...
 * @author Nhat Anh
 */
@WebServlet(name="coupon", urlPatterns={"/coupon"})
public class coupon extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet coupon</title>");  
            out.println("</head>");
            out.println("<body>");
    ...
    throws ServletException, IOException {
        CouponDAO d = new CouponDAO();
        String message = "Does not exist!";
        String color = "red";
        String code = request.getParameter("code");
        double discount = d.isDiscount(code);
        if(discount>0){
            message = "Successfully!";
            color = "green";
        }
        request.setAttribute("discount", (int)(discount*100));
