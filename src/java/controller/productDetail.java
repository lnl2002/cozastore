...
public class productDetail extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<String> listSize = d.getSizeByProductId(productId);
        List<Products> relatedProducts = d.getRealatedProducts(product.getCategoryId());
        String display = "none";
        if(listSize.size()>0) display = "flex";
        ...
        request.setAttribute("description", product.getDescript());
