 ...
 * @author Nhat Anh
 */
@WebServlet(name="deleteProductFromCart", urlPatterns={"/delete-product-from-cart"})
public class deleteProductFromCart extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int cartId = d.getCartIdByAccountId(account.getAccountID());
        d.delete(cartId, productId);
